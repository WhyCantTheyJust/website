...
title = "Why can't they just plug all those tax loopholes?"
Description = "Welcome to a new season. In our first episode, Janaline, Glenn and Luke consider why the Government can't just plug the budget's $200 billion worth of tax loopholes (called 'tax expenditures'). There are lots of reasons, and we think they can and should plug some of them."
episode_image = ""
explicit = "no"
author = "Janaline"
guests = []
tags = ["tax", "economic policy", "inequality"]
draft = false
+++
