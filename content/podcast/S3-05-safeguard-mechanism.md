...
date = '2026-09-21'
episode = "S3-05"
slug = "safeguard mechanism"
aliases = ["/S3-05"]
spotify = "6a4VduGCWmJpPDZxYYc0qH"
hosts = ["janaline", "luke", "glenn"]
title = "Can the government really fix industrial emissions?"
Description = "Janaline, Luke and Glenn look at the Safeguard Mechanism - the government's main policy to manage down industrial emissions - and how it can be made more effective. How can it make miners and fossil fuel companies do more of the heavy lifting, and shouldn't the whole thing just be scrapped for an economy-wide price on carbon? Maybe a focus on methane will help? This episode carries a nerd alert, but we hope you will bear with us because it genuinely is so important."
episode_image = ""
explicit = "no"
author = "Janaline"
guests = []
...
[link to podcast](https://open.spotify.com/episode/6a4VduGCWmJpPDZxYYc0qH?si=KpwcFCADQjC5eOGdwBYEJg)
