...
Description = "Janaline and William discuss the state of the international rules-based order and the current dynamics of the Australia-US relationship following Kevin Rudd's early departure as ambassador."
episode_image = ""
explicit = "no"
author = "Janaline"
guests = []
tags = ["foreign policy", "US alliance", "defence", "national security", "international law"]
draft = false
+++
